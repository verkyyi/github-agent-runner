...
Install one workflow from the curated catalog into the current repo, end to end: fetch, configure auth, commit, verify.

## Flow

1. Resolve the workflow name against `../discover-workflows/catalog.md`. If the user didn't name one, suggest running `/discover-workflows` first and stop.
