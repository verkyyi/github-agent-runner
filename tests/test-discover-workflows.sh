...
output=$(run_claude "What is the discover-workflows skill? Describe its job briefly." 90)
...
output=$(run_claude "Where does the discover-workflows skill get its workflow list from? Is it stored in a local file or fetched from somewhere at runtime?" 90)
...
output=$(run_claude "If the upstream source (githubnext/agentics) is unreachable at runtime, what should the discover-workflows skill do?" 90)
